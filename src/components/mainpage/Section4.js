...
const Section4 = forwardRef((props, ref) => {
  return (
    <div className={'section4 flex flex-col py-20 flex-nowrap justify-center items-center'} ref={ref}>
      ...
      <div className={'mt-8 flex flex-row flex-nowrap justify-center items-center text-center'}>
        <div className={'mr-4 bg-gray-200 rounded-full px-6 py-2 text-base'}>팀단위 구성(2인 이상, 5인 이하)</div>
