...
const Section6 = forwardRef((props, ref) => {
  return (
    <div className={'section6 flex flex-col py-20 flex-nowrap justify-center items-center'} ref={ref}>
      <div className={'title text-4xl font-bold border-solid'}>
        <p>시상 내역</p>
        <div className={'title_line mt-1'} />
      </div>
      <div style={{ width: 960 }} className={'flex flex-col items-center mt-16 text-xl text-center font-bold'}>
